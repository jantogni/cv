...
\cvlistitem{\textbf{Lenguajes}: C, C++, C\#, Python, Java, Prolog, Scheme, Pascal, Mathematica, Matlab, Qt}{}
\cvlistitem{\textbf{DBA}: postgreSQL, MySQL}{}
\cvlistitem{\textbf{Sistemas operativos}: (linux base) Redhat, Debian}{}
\cvlistitem{\textbf{Sistemas operativos}: (Microsoft) Windows XP, Vista, 7}{}
...
\cventry{2009}{ACS Workshop}{Presente en el trac Basico}{UTFSM}{Valparaíso}{}
...
\cvlistitem{Métodos y modelos cuantitativos}{}
...
\section{Premios}
\cvlistitem{Parte de la \emph{Lista de Honor} de la UTFSM, por la excelencia académica en los años 2008 2009 2010}
\cvlistitem{Primer lugar en excelencia académica en enseñanza media, Liceo Neandro Schilling, San Fernando}
